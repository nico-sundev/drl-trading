...
from ai_trading.train_and_test import create_env_and_train_agents, test_and_visualize_agents
...
train_env, val_env, ppo_agent, a2c_agent, ddpg_agent, sac_agent, td3_agent, ensemble_agent = create_env_and_train_agents(data_sets.training_data, data_sets.validation_data, total_timesteps, threshold)
