...
class TestFeatureConfigRepository:
    ...
    def test_get_config_not_found(self, reader, mock_session_factory, mock_session):
        """Test config retrieval when version not found."""
        # Given
        mock_session_factory.get_read_only_session.return_value.__enter__.return_value = mock_session
    ...
    def test_get_config_database_error(self, reader, mock_session_factory, mock_session):
        """Test config retrieval with database error."""
        # Given
        mock_session_factory.get_read_only_session.return_value.__enter__.return_value = mock_session
    ...
    @patch('drl_trading_adapter.adapter.feature_config.feature_config_repository.FeatureConfigMapper')
