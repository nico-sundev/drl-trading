...
def offline_s3_repo(s3_feature_store_config: FeatureStoreConfig):
    """Create OfflineS3ParquetFeatureRepo for testing with real S3 backend."""
    from drl_trading_adapter.adapter.feature_store.offline.parquet import (
        OfflineS3ParquetFeatureRepo,
    )

    return OfflineS3ParquetFeatureRepo(s3_feature_store_config)
