...
@pytest.fixture
def sample_csv_service(mocked_container: ApplicationContainer) -> CsvDataImportService:
    """Fixture for testing CSV import."""
    return mocked_container.csv_data_import_service()


@pytest.fixture
def create_csv_service_with_limit(mocked_container: ApplicationContainer):
    ...
    def _factory(limit: int) -> CsvDataImportService:
        ...
        base_config = mocked_container.application_config().local_data_import_config
...
def test_csv_import_all_timeframes(sample_csv_service: CsvDataImportService):
    ...
    # When
    symbol_containers = sample_csv_service.import_data()  # No limit to get all data
