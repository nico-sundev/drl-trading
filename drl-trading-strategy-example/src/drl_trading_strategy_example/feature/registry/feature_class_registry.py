...
class FeatureClassRegistry(ThreadSafeDiscoverableRegistry[FeatureTypeEnum, BaseFeature], IFeatureClassRegistry):
    ...
    def has_feature_class(self, feature_name: str) -> bool:
        ...
        try:
            ...
            logger.debug(f"Feature class check failed for '{feature_name}': {e}")
            return False
