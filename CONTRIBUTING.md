...
Welcome to `ai_trading` contributor's guide.
...
If you experience bugs or general issues with `ai_trading`, please have a look
...
You can help improve `ai_trading` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ai_trading` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ai_trading`'s files. While this mechanism can
...
```
conda create -n ai_trading python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ai_trading.git
   cd ai_trading
   ```
...
5. Install [pre-commit]:
   ...
   `ai_trading` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ai_trading
[issue tracker]: https://github.com/<USERNAME>/ai_trading/issues
