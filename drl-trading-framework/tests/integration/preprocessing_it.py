...
@pytest.fixture
def symbol_container(mocked_container) -> SymbolImportContainer:
...
@pytest.fixture
def preprocess_service(mocked_container) -> PreprocessServiceInterface:
    """Get preprocess service from the mocked container."""
    return mocked_container.preprocess_service()
